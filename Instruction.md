...
> Краткое пометка!
>
> Не удаляйте папки <b>instagram_posts</b> и <b>instagram_profiles</b>,
они нужны нам для сохранение постов и разных аккаунтов со всеми постами

## Чтобы узнать кол-во постов вы сможете найти эту информацию внизу инструкцией, а именно на 3-ем пункте, этого же файла
--
...
---------
--
# 2. Как скачать сколько-то постов или сколько-то Reels, по ссылке
### т.е сразу несколько пост или Reels
значение не ограничены
## *Файлы:*
...
## *Файлы:*
[download_more_posts..py](download_more_posts..py)

### С помощью данного файла мы сможем узнать, практичеки
---
--
# 4. Как посмотреть всю базовую информацию о профиле
## *Файлы:*
...
# В дополнение мы в этот проект добавили еще
1 файл и назвали этот файл profile_logo!

### Его функционал, как вы уже догадались - скачивает фотку аватара!
и все логотипы будут попадать в папку ```profiles_logo```
